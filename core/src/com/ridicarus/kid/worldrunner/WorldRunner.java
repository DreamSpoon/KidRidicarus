...
import com.ridicarus.kid.roles.robot.SMB.StaticCoin;
...
public class WorldRunner {
	...
	public void givePointsToPlayer(PlayerRole role, PointsAmount amount, boolean visible, Vector2 position,
			float yOffset, boolean isHeadBounce) {
		MarioRole mario;
		PointsAmount finalAmt;
