...
public class AgencyChangeQueue {
	...
	public void addAgent(AgentPlaceholder ap) {
		changeQ.add(new AgencyChange(AgencyChangeType.AGENT_LIST, true, ap, null, null));
	}

	public void removeAgent(AgentPlaceholder ap) {
		changeQ.add(new AgencyChange(AgencyChangeType.AGENT_LIST, false, ap, null, null));
	}

	public void addAgentUpdateListener(AgentPlaceholder ap, AgentUpdateListener auListener, AllowOrder updateOrder) {
		changeQ.add(new AgencyChange(AgencyChangeType.UPDATE_LISTENER, true, ap, auListener, updateOrder));
	}

	public void removeAgentUpdateListener(AgentPlaceholder ap, AgentUpdateListener auListener) {
		changeQ.add(new AgencyChange(AgencyChangeType.UPDATE_LISTENER, false, ap, auListener, null));
	}

	public void addAgentDrawListener(AgentPlaceholder ap, AgentDrawListener adListener, AllowOrder drawOrder) {
		changeQ.add(new AgencyChange(AgencyChangeType.DRAW_LISTENER, true, ap, adListener, drawOrder));
	}

	public void removeAgentDrawListener(AgentPlaceholder ap, AgentDrawListener adListener) {
		changeQ.add(new AgencyChange(AgencyChangeType.DRAW_LISTENER, false, ap, adListener, null));
	}

	public void addAgentRemoveListener(AgentPlaceholder ap, AgentRemoveListener arListener) {
		changeQ.add(new AgencyChange(AgencyChangeType.REMOVE_LISTENER, true, ap, arListener, null));
	}

	public void removeAgentRemoveListener(AgentPlaceholder ap, AgentRemoveListener arListener) {
		changeQ.add(new AgencyChange(AgencyChangeType.REMOVE_LISTENER, false, ap, arListener, null));
	}

	public void addAgentPropertyListener(AgentPlaceholder ap, AgentPropertyListener<?> apListener, String property) {
		changeQ.add(new AgencyChange(AgencyChangeType.PROPERTY_LISTENER, true, ap, apListener, property));
	}

	public void removeAgentPropertyListener(AgentPlaceholder ap, AgentPropertyListener<?> apListener, String property) {
		changeQ.add(new AgencyChange(AgencyChangeType.PROPERTY_LISTENER, false, ap, apListener, property));
	}
}
