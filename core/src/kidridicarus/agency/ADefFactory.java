...
public class ADefFactory {
	...
	public static AgentDef makeAgentSpawnTriggerDef(Guide player, Vector2 position, float width,
			float height) {
	...
	public static AgentDef makeFloatingPointsDef(PointAmount amt, boolean relative,
			Vector2 position, float yOffset, Mario player) {
	...
	public static AgentDef makeMarioDef(Guide player, Vector2 position) {
		AgentDef adef = makePointBoundsDef(position);
