...
public class TurtleBody extends MobileRobotBody implements BotGroundCheckBody, BotTouchBotBody, BotBumpableBody {
	...
	private TurtleRole role;

	public TurtleBody(TurtleRole role, World world, Vector2 position) {
		this.role = role;
	...
	private void defineBody(World world, Vector2 position, Vector2 velocity) {
		...
		b2body = B2DFactory.makeBoxBody(world, BodyType.DynamicBody, this, GameInfo.ROBOT_BIT,
				(short) (GameInfo.BOUNDARY_BIT | GameInfo.ROBOT_BIT | GameInfo.MARIO_ROBOSENSOR_BIT),
