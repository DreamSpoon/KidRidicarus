...
public class RobotSpawnBoxBody extends RobotBody implements Disposable {
	private RobotSpawnBox parent;

	public RobotSpawnBoxBody(RobotSpawnBox parent, World world, Rectangle bounds) {
		this.parent = parent;
	...
	@Override
	public RobotSpawnBox getParent() {
		return parent;
	}
}
