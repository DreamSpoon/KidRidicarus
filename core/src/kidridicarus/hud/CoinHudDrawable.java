...
public class CoinHudDrawable extends BaseDrawable {
	...
	public CoinHudDrawable(TextureAtlas atlas) {
		...
		frames.add(new TextureRegion(atlas.findRegion(GameInfo.TEXATLAS_COIN_HUD), 0, 0, 8, 8));
		frames.add(new TextureRegion(atlas.findRegion(GameInfo.TEXATLAS_COIN_HUD), 0, 0, 8, 8));
		frames.add(new TextureRegion(atlas.findRegion(GameInfo.TEXATLAS_COIN_HUD), 8, 0, 8, 8));
		frames.add(new TextureRegion(atlas.findRegion(GameInfo.TEXATLAS_COIN_HUD), 16, 0, 8, 8));
		frames.add(new TextureRegion(atlas.findRegion(GameInfo.TEXATLAS_COIN_HUD), 8, 0, 8, 8));
