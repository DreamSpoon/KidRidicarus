...
public class OrthoTiledMapBody extends AgentBody {
	...
	private OrthoCollisionTiledMapAgent parent;

	public OrthoTiledMapBody(OrthoCollisionTiledMapAgent parent, World world, Rectangle bounds) {
		this.parent = parent;
	...
	@Override
	public OrthoCollisionTiledMapAgent getParent() {
		return parent;
	}
}
