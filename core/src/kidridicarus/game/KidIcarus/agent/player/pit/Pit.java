...
public class Pit extends PlayerAgent implements PowerupTakeAgent, ContactDmgTakeAgent, HeadBounceGiveAgent {
	...
	private void processSprite(float delta) {
		if(supervisor.isRunningScriptNoMoveAdvice()) {
			...
			sprite.processFrame(new PitSpriteFrameInput(sss.position, sss.isFacingRight, delta,
					scriptedMoveState, false, false, false, false, sss.moveDir));
		}
		else {
			sprite.processFrame(new PitSpriteFrameInput(body.getPosition(), isFacingRight, delta,
