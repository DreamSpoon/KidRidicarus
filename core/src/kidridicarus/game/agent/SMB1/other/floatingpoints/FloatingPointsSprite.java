package kidridicarus.game.agent.SMB1.other.floatingpoints;
...
public class FloatingPointsSprite extends Sprite {
	...
	public FloatingPointsSprite(TextureAtlas atlas, Vector2 position, int amount, boolean is1Up) {
		...
		dSprites[PDigit.DIGIT_0.ordinal()] = new Sprite(atlas.findRegion(SMB1_Gfx.General.POINTDIGIT0));
		dSprites[PDigit.DIGIT_1.ordinal()] = new Sprite(atlas.findRegion(SMB1_Gfx.General.POINTDIGIT1));
		dSprites[PDigit.DIGIT_2.ordinal()] = new Sprite(atlas.findRegion(SMB1_Gfx.General.POINTDIGIT2));
		dSprites[PDigit.DIGIT_4.ordinal()] = new Sprite(atlas.findRegion(SMB1_Gfx.General.POINTDIGIT4));
		dSprites[PDigit.DIGIT_5.ordinal()] = new Sprite(atlas.findRegion(SMB1_Gfx.General.POINTDIGIT5));
		dSprites[PDigit.DIGIT_8.ordinal()] = new Sprite(atlas.findRegion(SMB1_Gfx.General.POINTDIGIT8));
